...
/***/ function(module, exports, __webpack_require__) {
	...
	var _shortanswer = __webpack_require__(55);
	...
	var _essay = __webpack_require__(63);
	...
	var _multiplechoice = __webpack_require__(64);
	...
	var _checklist = __webpack_require__(65);
	...
	var _selection = __webpack_require__(67);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _selection = __webpack_require__(46);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dompos = __webpack_require__(47);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _range = __webpack_require__(53);
	...
	var _command = __webpack_require__(43);
	...
	var _base_commands = __webpack_require__(44);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sortedinsert = __webpack_require__(33);
	...
	var _selection2 = __webpack_require__(46);

	var _dompos = __webpack_require__(47);

	var _draw = __webpack_require__(48);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (mod) {
	  ...
	  Keymap.prototype = {
	    ...
	    addBinding: function addBinding(keyname, value) {
	    ...
	    removeBinding: function removeBinding(keyname) {
	      var keys = this.normalize(keyname);
	    ...
	    unusedMulti: function unusedMulti(name) {
	    ...
	    lookup: function lookup(key, context) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _step = __webpack_require__(25);
	...
	var _ancestor = __webpack_require__(27);
	...
	var _join = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _step2 = __webpack_require__(25);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _from_dom = __webpack_require__(38);
	...
	var _to_dom = __webpack_require__(39);
	...
	var _from_text = __webpack_require__(40);
	...
	var _to_text = __webpack_require__(41);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _char = __webpack_require__(45);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _capturekeys = __webpack_require__(50);

	var _dom = __webpack_require__(14);

	var _domchange = __webpack_require__(51);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _blockmath = __webpack_require__(69);
	...
	if (document.getElementById && document.childNodes && document.createElement) {
	  if (!(window.MathJax && MathJax.Hub)) {
	    if (window.MathJax) {
	      ...
	      window.MathJax = {};
	    }MathJax.isPacked = true;MathJax.version = "2.6.1";MathJax.fileversion = "2.6.1";MathJax.cdnVersion = "2.6.1";MathJax.cdnFileVersions = {};(function (d) {
	      var b = window[d];if (!b) {
	        b = window[d] = {};
	      }var e = [];var c = function c(f) {
	        var g = f.constructor;if (!g) {
	          g = function g() {};
	        }for (var h in f) {
	        ...
	        return function () {
	      ...
	      };b.Object = c({ constructor: a(), Subclass: function Subclass(f, h) {
	          var g = a();g.SUPER = this;g.Init = this.Init;g.Subclass = this.Subclass;g.Augment = this.Augment;g.protoFunction = this.protoFunction;g.can = this.can;g.has = this.has;g.isa = this.isa;g.prototype = new this(e);g.prototype.constructor = g;g.Augment(f, h);return g;
	        }, Init: function Init(f) {
	          var g = this;if (f.length === 1 && f[0] === e) {
	            return g;
	          }if (!(g instanceof f.callee)) {
	            g = new f.callee(e);
	          }return g.Init.apply(g, f) || g;
	        }, Augment: function Augment(f, g) {
	          var h;if (f != null) {
	            for (h in f) {
	        ...
	        }, protoFunction: function protoFunction(g, f) {
	          this.prototype[g] = f;if (typeof f === "function") {
	            f.SUPER = this.SUPER.prototype;
	          }
	        }, prototype: { Init: function Init() {}, SUPER: function SUPER(f) {
	        ...
	        }, SimpleSUPER: c({ constructor: function constructor(f) {
	            return this.SimpleSUPER.define(f);
	          }, define: function define(f) {
	            var h = {};if (f != null) {
	              for (var g in f) {
	          ...
	          }, wrap: function wrap(i, h) {
	            if (typeof h !== "function" || !h.toString().match(/\.\s*SUPER\s*\(/)) {
	              return h;
	            }var g = function g() {
	              this.SUPER = g.SUPER[i];try {
	                var f = h.apply(this, arguments);
	              } catch (j) {
	                delete this.SUPER;throw j;
	              }delete this.SUPER;return f;
	            };g.toString = function () {
	              return h.toString.apply(h, arguments);
	            };return g;
	          } }) });
	    })("MathJax");(function (BASENAME) {
	      var BASE = window[BASENAME];if (!BASE) {
	        ...
	        }cb.toString = CALLBACK.prototype.toString;return cb;
	      };CALLBACK.prototype = { isCallback: true, hook: function hook() {}, data: [], object: window, execute: function execute() {
	          if (!this.called || this.autoReset) {
	            this.called = !this.autoReset;return this.hook.apply(this.object, this.data.concat([].slice.call(arguments, 0)));
	          }
	        }, reset: function reset() {
	          delete this.called;
	        }, toString: function toString() {
	          return this.hook.toString.apply(this.hook, arguments);
	        } };var ISCALLBACK = function ISCALLBACK(f) {
	        return typeof f === "function" && f.isCallback;
	      };var EVAL = function EVAL(code) {
	        return eval.call(window, code);
	      };var _TESTEVAL = function TESTEVAL() {
	        EVAL("var __TeSt_VaR__ = 1");if (window.__TeSt_VaR__) {
	          try {
	          ...
	          if (window.execScript) {
	            EVAL = function EVAL(code) {
	              BASE.__code = code;code = "try {" + BASENAME + ".__result = eval(" + BASENAME + ".__code)} catch(err) {" + BASENAME + ".__result = err}";window.execScript(code);var result = BASE.__result;delete BASE.__result;delete BASE.__code;if (result instanceof Error) {
	                throw result;
	              }return result;
	            };
	          } else {
	            EVAL = function EVAL(code) {
	              BASE.__code = code;code = "try {" + BASENAME + ".__result = eval(" + BASENAME + ".__code)} catch(err) {" + BASENAME + ".__result = err}";var head = document.getElementsByTagName("head")[0];if (!head) {
	                head = document.body;
	              }var script = document.createElement("script");script.appendChild(document.createTextNode(code));head.appendChild(script);head.removeChild(script);var result = BASE.__result;delete BASE.__result;delete BASE.__code;if (result instanceof Error) {
	                throw result;
	              }return result;
	            };
	          }
	        }_TESTEVAL = null;
	      };var USING = function USING(args, i) {
	        ...
	        callback = USING(callback);callback.timeout = setTimeout(callback, time);return callback;
	      };var WAITFOR = function WAITFOR(callback, signal) {
	        callback = USING(callback);if (!callback.called) {
	          WAITSIGNAL(callback, signal);signal.pending++;
	        }
	      };var WAITEXECUTE = function WAITEXECUTE() {
	        var signals = this.signal;delete this.signal;this.execute = this.oldExecute;delete this.oldExecute;var result = this.execute.apply(this, arguments);if (ISCALLBACK(result) && !result.called) {
	          WAITSIGNAL(result, signals);
	        } else {
	          for (var i = 0, m = signals.length; i < m; i++) {
	            signals[i].pending--;if (signals[i].pending <= 0) {
	              signals[i].call();
	            }
	          }
	        }
	      };var WAITSIGNAL = function WAITSIGNAL(callback, signals) {
	        if (!(signals instanceof Array)) {
	          signals = [signals];
	        }if (!callback.signal) {
	          callback.oldExecute = callback.execute;callback.execute = WAITEXECUTE;callback.signal = signals;
	        } else {
	          if (signals.length === 1) {
	        ...
	        callback = USING(callback);callback.pending = 0;for (var i = 1, m = arguments.length; i < m; i++) {
	          if (arguments[i]) {
	            WAITFOR(arguments[i], callback);
	          }
	        }if (callback.pending === 0) {
	          var result = callback();if (ISCALLBACK(result)) {
	            callback = result;
	          }
	        }return callback;
	      };var HOOKS = MathJax.Object.Subclass({ Init: function Init(reset) {
	          this.hooks = [];this.remove = [];this.reset = reset;this.running = false;
	        }, Add: function Add(hook, priority) {
	          if (priority == null) {
	            priority = 10;
	          }if (!ISCALLBACK(hook)) {
	            hook = USING(hook);
	          }hook.priority = priority;var i = this.hooks.length;while (i > 0 && priority < this.hooks[i - 1].priority) {
	            i--;
	          }this.hooks.splice(i, 0, hook);return hook;
	          ...
	          var callbacks = [{}];this.running = true;for (var i = 0, m = this.hooks.length; i < m; i++) {
	            if (this.reset) {
	              this.hooks[i].reset();
	            }var result = this.hooks[i].apply(window, arguments);if (ISCALLBACK(result) && !result.called) {
	              callbacks.push(result);
	            }
	          }this.running = false;if (this.remove.length) {
	            this.RemovePending();
	        ...
	        }, RemovePending: function RemovePending() {
	          this.remove = this.remove.sort();for (var i = this.remove.length - 1; i >= 0; i--) {
	            this.hooks.splice(i, 1);
	          }this.remove = [];
	        } });var EXECUTEHOOKS = function EXECUTEHOOKS(hooks, data, reset) {
	        if (!hooks) {
	          return null;
	          ...
	          data = data == null ? [] : [data];
	        }var handler = HOOKS(reset);for (var i = 0, m = hooks.length; i < m; i++) {
	          handler.Add(hooks[i]);
	        }return handler.Execute.apply(handler, data);
	      };var QUEUE = BASE.Object.Subclass({ Init: function Init() {
	          this.pending = this.running = 0;this.queue = [];this.Push.apply(this, arguments);
	        }, Push: function Push() {
	          var callback;for (var i = 0, m = arguments.length; i < m; i++) {
	            callback = USING(arguments[i]);if (callback === arguments[i] && !callback.called) {
	              callback = USING(["wait", this, callback]);
	            }this.queue.push(callback);
	          }if (!this.running && !this.pending) {
	            this.Process();
	          }return callback;
	        }, Process: function Process(queue) {
	          while (!this.running && !this.pending && this.queue.length) {
	            var callback = this.queue[0];queue = this.queue.slice(1);this.queue = [];this.Suspend();var result = callback();this.Resume();if (queue.length) {
	          ...
	          return callback;
	        } });var SIGNAL = QUEUE.Subclass({ Init: function Init(name) {
	          QUEUE.prototype.Init.call(this);this.name = name;this.posted = [];this.listeners = HOOKS(true);this.posting = false;this.callback = null;
	        }, Post: function Post(message, callback, forget) {
	          callback = USING(callback);if (this.posting || this.pending) {
	            this.Push(["Post", this, message, callback, forget]);
	          } else {
	            this.callback = callback;callback.reset();if (!forget) {
	              this.posted.push(message);
	            }this.Suspend();this.posting = true;var result = this.listeners.Execute(message);if (ISCALLBACK(result) && !result.called) {
	              WAITFOR(result, this);
	            }this.Resume();this.posting = false;if (!this.pending) {
	              this.call();
	            }
	          }return callback;
	        ...
	        }, Interest: function Interest(callback, ignorePast, priority) {
	          callback = USING(callback);this.listeners.Add(callback, priority);if (!ignorePast) {
	            for (var i = 0, m = this.posted.length; i < m; i++) {
	              callback.reset();var result = callback(this.posted[i]);if (ISCALLBACK(result) && i === this.posted.length - 1) {
	                WAITFOR(result, this);
	              }
	            }
	          }return callback;
	        }, NoInterest: function NoInterest(callback) {
	          this.listeners.Remove(callback);
	        }, MessageHook: function MessageHook(msg, callback, priority) {
	          callback = USING(callback);if (!this.hooks) {
	          ...
	          }callback.msg = msg;return callback;
	        }, ExecuteHooks: function ExecuteHooks(msg) {
	          var type = msg instanceof Array ? msg[0] : msg;if (!this.hooks[type]) {
	            return null;
	          }return this.hooks[type].Execute(msg);
	        }, RemoveHook: function RemoveHook(hook) {
	          this.hooks[hook.msg].Remove(hook);
	        } }, { signals: {}, find: function find(name) {
	          if (!SIGNAL.signals[name]) {
	            SIGNAL.signals[name] = new SIGNAL(name);
	          }return SIGNAL.signals[name];
	        } });BASE.Callback = BASE.CallBack = USING;BASE.Callback.Delay = DELAY;BASE.Callback.After = AFTER;BASE.Callback.Queue = QUEUE;BASE.Callback.Signal = SIGNAL.find;BASE.Callback.Hooks = HOOKS;BASE.Callback.ExecuteHooks = EXECUTEHOOKS;
	    })("MathJax");(function (e) {
	      var a = window[e];if (!a) {
	        a = window[e] = {};
	      }var d = navigator.vendor === "Apple Computer, Inc." && typeof navigator.vendorSub === "undefined";var g = 0;var h = function h(i) {
	        if (document.styleSheets && document.styleSheets.length > g) {
	          g = document.styleSheets.length;
	        }if (!i) {
	          i = document.head || document.getElementsByTagName("head")[0];if (!i) {
	            i = document.body;
	          }
	        }return i;
	      };var f = [];var c = function c() {
	        for (var k = 0, j = f.length; k < j; k++) {
	          a.Ajax.head.removeChild(f[k]);
	        }f = [];
	      };var b = {};b[e] = "";a.Ajax = { loaded: {}, loading: {}, loadHooks: {}, timeout: 15 * 1000, styleDelay: 1, config: { root: "", path: b }, STATUS: { OK: 1, ERROR: -1 }, fileURL: function fileURL(j) {
	          var i = j.match(/^\[([-._a-z0-9]+)\]/i);if (i && i[1] in b) {
	            j = (b[i[1]] || this.config.root) + j.substr(i[1].length + 2);
	          }return j;
	        }, fileName: function fileName(j) {
	          var i = this.config.root;if (j.substr(0, i.length) === i) {
	            j = "[" + e + "]" + j.substr(i.length);
	          } else {
	            for (var k in b) {
	              if (b.hasOwnProperty(k) && b[k]) {
	                if (j.substr(0, b[k].length) === b[k]) {
	                  j = "[" + k + "]" + j.substr(b[k].length);break;
	                }
	              }
	            }
	          }return j;
	        }, fileRev: function fileRev(j) {
	          var i = a.cdnFileVersions[name] || a.cdnVersion;if (i) {
	            i = "?rev=" + i;
	          }return i;
	        }, urlRev: function urlRev(i) {
	          return this.fileURL(i) + this.fileRev(i);
	        }, Require: function Require(k, n) {
	          n = a.Callback(n);var l;if (k instanceof Object) {
	            for (var j in k) {
	              if (k.hasOwnProperty(j)) {
	                l = j.toUpperCase();k = k[j];
	              }
	            }
	          } else {
	            l = k.split(/\./).pop().toUpperCase();
	          }k = this.fileURL(k);if (this.loaded[k]) {
	            n(this.loaded[k]);
	          } else {
	            var m = {};m[l] = k;this.Load(m, n);
	          }return n;
	        }, Load: function Load(k, m) {
	          m = a.Callback(m);var l;if (k instanceof Object) {
	            for (var j in k) {
	              if (k.hasOwnProperty(j)) {
	                l = j.toUpperCase();k = k[j];
	              }
	            ...
	            l = k.split(/\./).pop().toUpperCase();
	          }k = this.fileURL(k);if (this.loading[k]) {
	            this.addHook(k, m);
	          } else {
	            this.head = h(this.head);if (this.loader[l]) {
	              this.loader[l].call(this, k, m);
	            } else {
	              throw Error("Can't load files of type " + l);
	            }
	          }return m;
	        }, LoadHook: function LoadHook(l, m, k) {
	          m = a.Callback(m);if (l instanceof Object) {
	            for (var j in l) {
	              if (l.hasOwnProperty(j)) {
	                l = l[j];
	              }
	            }
	          }l = this.fileURL(l);if (this.loaded[l]) {
	            m(this.loaded[l]);
	          } else {
	            this.addHook(l, m, k);
	          }return m;
	        }, addHook: function addHook(j, k, i) {
	          if (!this.loadHooks[j]) {
	            this.loadHooks[j] = MathJax.Callback.Hooks();
	          }this.loadHooks[j].Add(k, i);k.file = j;
	        }, removeHook: function removeHook(i) {
	          if (this.loadHooks[i.file]) {
	            this.loadHooks[i.file].Remove(i);if (!this.loadHooks[i.file].hooks.length) {
	              delete this.loadHooks[i.file];
	            }
	          }
	        }, Preloading: function Preloading() {
	          for (var l = 0, j = arguments.length; l < j; l++) {
	            var k = this.fileURL(arguments[l]);if (!this.loading[k]) {
	              this.loading[k] = { preloaded: true };
	            }
	          }
	        }, loader: { JS: function JS(k, m) {
	            var j = this.fileName(k);var i = document.createElement("script");var l = a.Callback(["loadTimeout", this, k]);this.loading[k] = { callback: m, timeout: setTimeout(l, this.timeout), status: this.STATUS.OK, script: i };this.loading[k].message = a.Message.File(j);i.onerror = l;i.type = "text/javascript";i.src = k + this.fileRev(j);this.head.appendChild(i);
	          }, CSS: function CSS(j, l) {
	            var i = this.fileName(j);var k = document.createElement("link");k.rel = "stylesheet";k.type = "text/css";k.href = j + this.fileRev(i);this.loading[j] = { callback: l, message: a.Message.File(i), status: this.STATUS.OK };this.head.appendChild(k);this.timer.create.call(this, [this.timer.file, j], k);
	          } }, timer: { create: function create(j, i) {
	            j = a.Callback(j);if (i.nodeName === "STYLE" && i.styleSheet && typeof i.styleSheet.cssText !== "undefined") {
	              j(this.STATUS.OK);
	            } else {
	          ...
	          }, start: function start(j, i, k, l) {
	            i = a.Callback(i);i.execute = this.execute;i.time = this.time;i.STATUS = j.STATUS;i.timeout = l || j.timeout;i.delay = i.total = k || 0;if (k) {
	              setTimeout(i, k);
	            } else {
	              i();
	            }
	          }, time: function time(i) {
	            this.total += this.delay;this.delay = Math.floor(this.delay * 1.05 + 5);if (this.total >= this.timeout) {
	              i(this.STATUS.ERROR);return 1;
	            }return 0;
	          }, file: function file(j, i) {
	            if (i < 0) {
	          ...
	          }, checkSafari2: function checkSafari2(i, j, k) {
	            if (i.time(k)) {
	              return;
	          ...
	          }, checkLength: function checkLength(i, l, n) {
	            if (i.time(n)) {
	              return;
	            }var m = 0;var j = l.sheet || l.styleSheet;try {
	          ...
	          } }, loadComplete: function loadComplete(i) {
	          i = this.fileURL(i);var j = this.loading[i];if (j && !j.preloaded) {
	            a.Message.Clear(j.message);clearTimeout(j.timeout);if (j.script) {
	              if (f.length === 0) {
	                setTimeout(c, 0);
	              }f.push(j.script);
	            }this.loaded[i] = j.status;delete this.loading[i];this.addHook(i, j.callback);
	          } else {
	            if (j) {
	              delete this.loading[i];
	            }this.loaded[i] = this.STATUS.OK;j = { status: this.STATUS.OK };
	          }if (!this.loadHooks[i]) {
	            return null;
	          }return this.loadHooks[i].Execute(j.status);
	        }, loadTimeout: function loadTimeout(i) {
	          if (this.loading[i].timeout) {
	            clearTimeout(this.loading[i].timeout);
	          }this.loading[i].status = this.STATUS.ERROR;this.loadError(i);this.loadComplete(i);
	        }, loadError: function loadError(i) {
	          a.Message.Set(["LoadFailed", "File failed to load: %1", i], null, 2000);a.Hub.signal.Post(["file load error", i]);
	        }, Styles: function Styles(k, l) {
	          var i = this.StyleString(k);if (i === "") {
	            l = a.Callback(l);l();
	          } else {
	            var j = document.createElement("style");j.type = "text/css";this.head = h(this.head);this.head.appendChild(j);if (j.styleSheet && typeof j.styleSheet.cssText !== "undefined") {
	              j.styleSheet.cssText = i;
	            } else {
	              j.appendChild(document.createTextNode(i));
	            }l = this.timer.create.call(this, l, j);
	          }return l;
	        }, StyleString: function StyleString(n) {
	          if (typeof n === "string") {
	            return n;
	          }var k = "",
	              o,
	              ...
	              if (typeof n[o] === "string") {
	                ...
	                if (n[o] instanceof Array) {
	                  for (var l = 0; l < n[o].length; l++) {
	                    m = {};m[o] = n[o][l];k += this.StyleString(m);
	                  }
	                } else {
	    ...
	    })("MathJax");MathJax.HTML = { Element: function Element(d, f, e) {
	        var g = document.createElement(d),
	            h;if (f) {
	          if (f.hasOwnProperty("style")) {
	            var c = f.style;f.style = {};for (h in c) {
	              if (c.hasOwnProperty(h)) {
	                f.style[h.replace(/-([a-z])/g, this.ucMatch)] = c[h];
	              }
	            }
	          }MathJax.Hub.Insert(g, f);for (h in f) {
	      ...
	      }, ucMatch: function ucMatch(a, b) {
	        return b.toUpperCase();
	      }, addElement: function addElement(b, a, d, c) {
	        return b.appendChild(this.Element(a, d, c));
	      }, TextNode: function TextNode(a) {
	        return document.createTextNode(a);
	      }, addText: function addText(a, b) {
	        return a.appendChild(this.TextNode(b));
	      }, setScript: function setScript(a, b) {
	      ...
	      }, getScript: function getScript(a) {
	        var b = a.text === "" ? a.innerHTML : a.text;return b.replace(/^\s+/, "").replace(/\s+$/, "");
	      }, Cookie: { prefix: "mjx", expires: 365, Set: function Set(a, e) {
	          var d = [];if (e) {
	            for (var g in e) {
	          ...
	          }var b = this.prefix + "." + a + "=" + escape(d.join("&;"));if (this.expires) {
	            var f = new Date();f.setDate(f.getDate() + this.expires);b += "; expires=" + f.toGMTString();
	          }try {
	            document.cookie = b + "; path=/";
	          } catch (c) {}
	        }, Get: function Get(a, d) {
	          if (!d) {
	            d = {};
	          }var g = new RegExp("(?:^|;\\s*)" + this.prefix + "\\." + a + "=([^;]*)(?:;|$)");var f;try {
	            f = g.exec(document.cookie);
	          } catch (c) {}if (f && f[1] !== "") {
	            var j = unescape(f[1]).split("&;");for (var e = 0, b = j.length; e < b; e++) {
	              f = j[e].match(/([^:]+):(.*)/);var h = f[2].replace(/&&/g, "&");if (h === "true") {
	                h = true;
	              } else {
	                if (h === "false") {
	                  h = false;
	        ...
	        var a = [],
	            b,
	            d = 0;e.lastIndex = 0;while (b = e.exec(c)) {
	          a.push(c.substr(d, b.index - d));a.push.apply(a, b.slice(1));d = b.index + b[0].length;
	        }a.push(c.substr(d));return a;
	      }, _: function _(b, a) {
	        if (a instanceof Array) {
	          return this.processSnippet(b, a);
	        }return this.processString(this.lookupPhrase(b, a), [].slice.call(arguments, 2));
	      }, processString: function processString(l, o, g) {
	        var j, e;for (j = 0, e = o.length; j < e; j++) {
	          if (g && o[j] instanceof Array) {
	            o[j] = this.processSnippet(g, o[j]);
	          }
	        }var f = this.SPLIT(l, this.pattern);for (j = 1, e = f.length; j < e; j += 2) {
	          var p = f[j].charAt(0);if (p >= "0" && p <= "9") {
	            f[j] = o[f[j] - 1];if (typeof f[j] === "number") {
	              f[j] = this.number(f[j]);
	            }
	          } else {
	            if (p === "{") {
	              p = f[j].substr(1);if (p >= "0" && p <= "9") {
	                f[j] = o[f[j].substr(1, f[j].length - 2) - 1];if (typeof f[j] === "number") {
	                  f[j] = this.number(f[j]);
	                }
	              } else {
	                var k = f[j].match(/^\{([a-z]+):%(\d+)\|(.*)\}$/);if (k) {
	                  if (k[1] === "plural") {
	                    var d = o[k[2] - 1];if (typeof d === "undefined") {
	                      f[j] = "???";
	                    } else {
	                      d = this.plural(d) - 1;var h = k[3].replace(/(^|[^%])(%%)*%\|/g, "$1$2%").split(/\|/);if (d >= 0 && d < h.length) {
	      ...
	      }, processSnippet: function processSnippet(g, e) {
	        var c = [];for (var d = 0, b = e.length; d < b; d++) {
	          if (e[d] instanceof Array) {
	            var f = e[d];if (typeof f[1] === "string") {
	              var h = f[0];if (!(h instanceof Array)) {
	                h = [g, h];
	              }var a = this.lookupPhrase(h, f[1]);c = c.concat(this.processMarkdown(a, f.slice(2), g));
	            } else {
	      ...
	      }, markdownPattern: /(%.)|(\*{1,3})((?:%.|.)+?)\2|(`+)((?:%.|.)+?)\4|\[((?:%.|.)+?)\]\(([^\s\)]+)\)/, processMarkdown: function processMarkdown(b, h, d) {
	        var j = [],
	            e;var c = b.split(this.markdownPattern);var g = c[0];for (var f = 1, a = c.length; f < a; f += 8) {
	          if (c[f + 1]) {
	            e = this.processString(c[f + 2], h, d);if (!(e instanceof Array)) {
	              e = [e];
	            }e = [["b", "i", "i"][c[f + 1].length - 1], {}, e];if (c[f + 1].length === 3) {
	              e = ["b", {}, e];
	            }
	          } else {
	            if (c[f + 3]) {
	              e = this.processString(c[f + 4].replace(/^\s/, "").replace(/\s$/, ""), h, d);if (!(e instanceof Array)) {
	                e = [e];
	              }e = ["code", {}, e];
	            } else {
	              if (c[f + 5]) {
	                e = this.processString(c[f + 5], h, d);if (!(e instanceof Array)) {
	                  e = [e];
	            ...
	            j = this.concatString(j, g, h, d);j.push(e);g = "";
	          }if (c[f + 7] !== "") {
	            g += c[f + 7];
	          }
	        }j = this.concatString(j, g, h, d);return j;
	      }, concatString: function concatString(a, c, b, d) {
	        if (c != "") {
	          c = this.processString(c, b, d);if (!(c instanceof Array)) {
	            c = [c];
	          }a = a.concat(c);
	        }return a;
	      }, lookupPhrase: function lookupPhrase(f, a, d) {
	        if (!d) {
	          d = "_";
	        }if (f instanceof Array) {
	          d = f[0] || "_";f = f[1] || "";
	        }var c = this.loadDomain(d);if (c) {
	          MathJax.Hub.RestartAfter(c);
	        }var b = this.strings[this.locale];if (b) {
	          if (b.domains && d in b.domains) {
	            var e = b.domains[d];if (e.strings && f in e.strings) {
	              a = e.strings[f];
	            }
	          }
	        }return a;
	      }, loadFile: function loadFile(b, d, e) {
	        e = MathJax.Callback(e);b = d.file || b;if (!b.match(/\.js$/)) {
	          b += ".js";
	        }if (!b.match(/^([a-z]+:|\[MathJax\])/)) {
	          var a = this.strings[this.locale].directory || this.directory + "/" + this.locale || "[MathJax]/localization/" + this.locale;b = a + "/" + b;
	        }var c = MathJax.Ajax.Require(b, function () {
	          d.isLoaded = true;return e();
	        });return c.called ? null : c;
	      }, loadDomain: function loadDomain(c, e) {
	        var b,
	            a = this.strings[this.locale];if (a) {
	          if (!a.isLoaded) {
	            b = this.loadFile(this.locale, a);if (b) {
	              return MathJax.Callback.Queue(b, ["loadDomain", this, c]).Push(e || {});
	            }
	          }if (a.domains && c in a.domains) {
	            var d = a.domains[c];if (!d.isLoaded) {
	              b = this.loadFile(c, d);if (b) {
	        ...
	        a = MathJax.Callback(a);a.autoReset = true;try {
	          a();
	        } catch (b) {
	          if (!b.restart) {
	            throw b;
	      ...
	      }, resetLocale: function resetLocale(a) {
	        if (!a) {
	          return;
	        }a = a.toLowerCase();while (!this.strings[a]) {
	          var c = a.lastIndexOf("-");if (c === -1) {
	            return;
	          }a = a.substring(0, c);
	        }var b = this.strings[a].remap;this.locale = b ? b : a;
	      }, setLocale: function setLocale(a) {
	        this.resetLocale(a);if (MathJax.Menu) {
	          this.loadDomain("MathMenu");
	        }
	      }, addTranslation: function addTranslation(b, e, c) {
	        var d = this.strings[b],
	            a = false;if (!d) {
	          d = this.strings[b] = {};a = true;
	        }if (!d.domains) {
	          d.domains = {};
	        }if (e) {
	          if (!d.domains[e]) {
	        ...
	        }MathJax.Hub.Insert(d, c);if (a && MathJax.Menu.menu) {
	          MathJax.Menu.CreateLocaleMenu();
	        }
	      }, setCSS: function setCSS(b) {
	        var a = this.strings[this.locale];if (a) {
	          if (a.fontFamily) {
	            b.style.fontFamily = a.fontFamily;
	          }if (a.fontDirection) {
	            b.style.direction = a.fontDirection;if (a.fontDirection === "rtl") {
	              b.style.textAlign = "right";
	            }
	          }
	        }return b;
	      }, fontFamily: function fontFamily() {
	        var a = this.strings[this.locale];return a ? a.fontFamily : null;
	      }, fontDirection: function fontDirection() {
	        var a = this.strings[this.locale];return a ? a.fontDirection : null;
	      }, plural: function plural(b) {
	        var a = this.strings[this.locale];if (a && a.plural) {
	          return a.plural(b);
	        }if (b == 1) {
	          return 1;
	        }return 2;
	      }, number: function number(b) {
	        var a = this.strings[this.locale];if (a && a.number) {
	          return a.number(b);
	        }return b;
	      } };MathJax.Message = { ready: false, log: [{}], current: null, textNodeBug: navigator.vendor === "Apple Computer, Inc." && typeof navigator.vendorSub === "undefined" || window.hasOwnProperty && window.hasOwnProperty("konqueror"), styles: { "#MathJax_Message": { position: "fixed", left: "1px", bottom: "2px", "background-color": "#E6E6E6", border: "1px solid #959595", margin: "0px", padding: "2px 8px", "z-index": "102", color: "black", "font-size": "80%", width: "auto", "white-space": "nowrap" }, "#MathJax_MSIE_Frame": { position: "absolute", top: 0, left: 0, width: "0px", "z-index": 101, border: "0px", margin: "0px", padding: "0px" } }, browsers: { MSIE: function MSIE(a) {
	          MathJax.Message.msieFixedPositionBug = (document.documentMode || 0) < 7;if (MathJax.Message.msieFixedPositionBug) {
	            MathJax.Hub.config.styles["#MathJax_Message"].position = "absolute";
	          }MathJax.Message.quirks = document.compatMode === "BackCompat";
	        }, Chrome: function Chrome(a) {
	        ...
	        if (a) {
	          ...
	          this.div = document.getElementById("MathJax_Message");if (this.div) {
	            this.text = this.div.firstChild;
	          }
	        }if (!this.div) {
	          var b = document.body;if (this.msieFixedPositionBug && window.attachEvent) {
	            b = this.frame = this.addDiv(document.body);b.removeAttribute("id");b.style.position = "absolute";b.style.border = b.style.margin = b.style.padding = "0px";b.style.zIndex = "101";b.style.height = "0px";b = this.addDiv(b);b.id = "MathJax_MSIE_Frame";window.attachEvent("onscroll", this.MoveFrame);window.attachEvent("onresize", this.MoveFrame);this.MoveFrame();
	          }this.div = this.addDiv(b);this.div.style.display = "none";this.text = this.div.appendChild(document.createTextNode(""));
	        }return true;
	      }, addDiv: function addDiv(a) {
	        var b = document.createElement("div");b.id = "MathJax_Message";if (a.firstChild) {
	          a.insertBefore(b, a.firstChild);
	        } else {
	          a.appendChild(b);
	        }return b;
	      }, MoveFrame: function MoveFrame() {
	        var a = MathJax.Message.quirks ? document.body : document.documentElement;var b = MathJax.Message.frame;b.style.left = a.scrollLeft + "px";b.style.top = a.scrollTop + "px";b.style.width = a.clientWidth + "px";b = b.firstChild;b.style.height = a.clientHeight + "px";
	      }, localize: function localize(a) {
	        return MathJax.Localization._(a, a);
	      }, filterText: function filterText(a, c, b) {
	        if (MathJax.Hub.config.messageStyle === "simple") {
	          if (b === "LoadFile") {
	            ...
	            if (b === "ProcessMath") {
	              ...
	              }a = this.processing;this.processing += ".";
	            } else {
	              if (b === "TypesetMath") {
	                if (!this.typesetting) {
	      ...
	      }, Set: function Set(c, e, b) {
	        if (e == null) {
	          e = this.log.length;this.log[e] = {};
	        }var d = "";if (c instanceof Array) {
	          d = c[0];if (d instanceof Array) {
	            d = d[1];
	          }try {
	            ...
	            if (!a.restart) {
	              ...
	              }this.log[e].restarted++;delete this.log[e].cleared;MathJax.Callback.After(["Set", this, c, e, b], a.restart);return e;
	            }
	          }
	        }if (this.timer) {
	          clearTimeout(this.timer);delete this.timer;
	        }this.log[e].text = c;this.log[e].filteredText = c = this.filterText(c, e, d);if (typeof this.log[e].next === "undefined") {
	          this.log[e].next = this.current;if (this.current != null) {
	          ...
	          if (this.Init()) {
	            ...
	            }this.div.style.display = "";if (this.status) {
	              window.status = "";delete this.status;
	            }
	          } else {
	            window.status = c;this.status = true;
	          }
	        ...
	        if (this.log[b].prev != null) {
	          ...
	          this.current = this.log[b].next;if (this.text) {
	        ...
	        }delete this.log[b].next;delete this.log[b].prev;delete this.log[b].filteredText;if (this.log[b].restarted) {
	        ...
	        var b = [];for (var c = 1, a = this.log.length; c < a; c++) {
	          b[c] = this.log[c].text;
	        }return b.join("\n");
	        ...
	        this.Insert(this.config, a);if (this.config.Augment) {
	          this.Augment(this.config.Augment);
	        }
	      }, CombineConfig: function CombineConfig(c, f) {
	        var b = this.config,
	            g,
	            e;c = c.split(/\./);for (var d = 0, a = c.length; d < a; d++) {
	          g = c[d];if (!b[g]) {
	            b[g] = {};
	          }e = b;b = b[g];
	        }e[g] = b = this.Insert(f, b);return b;
	      }, Register: { PreProcessor: function PreProcessor() {
	        ...
	        } }, UnRegister: { PreProcessor: function PreProcessor(a) {
	          MathJax.Hub.preProcessors.Remove(a);
	        }, MessageHook: function MessageHook(a) {
	          MathJax.Hub.signal.RemoveHook(a);
	        }, StartupHook: function StartupHook(a) {
	          MathJax.Hub.Startup.signal.RemoveHook(a);
	        }, LoadHook: function LoadHook(a) {
	          MathJax.Ajax.removeHook(a);
	        } }, getAllJax: function getAllJax(e) {
	        var c = [],
	            b = this.elementScripts(e);for (var d = 0, a = b.length; d < a; d++) {
	          if (b[d].MathJax && b[d].MathJax.elementJax) {
	            c.push(b[d].MathJax.elementJax);
	          }
	        }return c;
	      }, getJaxByType: function getJaxByType(f, e) {
	        var c = [],
	            b = this.elementScripts(e);for (var d = 0, a = b.length; d < a; d++) {
	      ...
	      }, getJaxByInputType: function getJaxByInputType(f, e) {
	        var c = [],
	            b = this.elementScripts(e);for (var d = 0, a = b.length; d < a; d++) {
	      ...
	      }, getJaxFor: function getJaxFor(a) {
	        if (typeof a === "string") {
	      ...
	      }, isMathJaxNode: function isMathJaxNode(a) {
	        return !!a && (a.isMathJax || (a.className || "") === "MathJax_MathML");
	      }, setRenderer: function setRenderer(d, c) {
	        if (!d) {
	          return;
	        }if (!MathJax.OutputJax[d]) {
	          this.config.menuSettings.renderer = "";var b = "[MathJax]/jax/output/" + d + "/config.js";return MathJax.Ajax.Require(b, ["setRenderer", this, d, c]);
	        } else {
	          this.config.menuSettings.renderer = d;if (c == null) {
	            c = "jax/mml";
	          }var a = this.outputJax;if (a[c] && a[c].length) {
	            if (d !== a[c][0].id) {
	              a[c].unshift(MathJax.OutputJax[d]);return this.signal.Post(["Renderer Selected", d]);
	            }
	          }return null;
	        }
	      }, Queue: function Queue() {
	        return this.queue.Push.apply(this.queue, arguments);
	      }, Typeset: function Typeset(c, d) {
	        if (!MathJax.isReady) {
	          return null;
	        }var b = this.elementCallback(c, d);if (b.count) {
	          var a = MathJax.Callback.Queue(["PreProcess", this, b.elements], ["Process", this, b.elements]);
	        }return a.Push(b.callback);
	      }, PreProcess: function PreProcess(e, g) {
	        var c = this.elementCallback(e, g);var b = MathJax.Callback.Queue();if (c.count) {
	          var f = c.count === 1 ? [c.elements] : c.elements;b.Push(["Post", this.signal, ["Begin PreProcess", c.elements]]);for (var d = 0, a = f.length; d < a; d++) {
	            if (f[d]) {
	              b.Push(["Execute", this.preProcessors, f[d]]);
	            }
	          }b.Push(["Post", this.signal, ["End PreProcess", c.elements]]);
	        }return b.Push(c.callback);
	      }, Process: function Process(a, b) {
	        return this.takeAction("Process", a, b);
	      }, Update: function Update(a, b) {
	        return this.takeAction("Update", a, b);
	      }, Reprocess: function Reprocess(a, b) {
	        return this.takeAction("Reprocess", a, b);
	      }, Rerender: function Rerender(a, b) {
	        return this.takeAction("Rerender", a, b);
	      }, takeAction: function takeAction(g, d, h) {
	        var c = this.elementCallback(d, h);var f = c.elements;var a = MathJax.Callback.Queue(["Clear", this.signal]);var e = { scripts: [], start: new Date().getTime(), i: 0, j: 0, jax: {}, jaxIDs: [] };if (c.count) {
	          var b = ["Delay", MathJax.Callback, this.processSectionDelay];if (!b[2]) {
	            b = {};
	      ...
	      }, scriptAction: { Process: function Process(a) {}, Update: function Update(b) {
	          var a = b.MathJax.elementJax;if (a && a.needsUpdate()) {
	            a.Remove(true);b.MathJax.state = a.STATE.UPDATE;
	          } else {
	            b.MathJax.state = a.STATE.PROCESSED;
	          }
	        }, Reprocess: function Reprocess(b) {
	          var a = b.MathJax.elementJax;if (a) {
	            a.Remove(true);b.MathJax.state = a.STATE.UPDATE;
	          }
	        }, Rerender: function Rerender(b) {
	          var a = b.MathJax.elementJax;if (a) {
	            a.Remove(true);b.MathJax.state = a.STATE.OUTPUT;
	          }
	        } }, prepareScripts: function prepareScripts(h, e, g) {
	        if (arguments.callee.disabled) {
	          return;
	        }var b = this.elementScripts(e);var f = MathJax.ElementJax.STATE;for (var d = 0, a = b.length; d < a; d++) {
	          var c = b[d];if (c.type && this.inputJax[c.type.replace(/ *;(.|\n)*/, "")]) {
	            if (c.MathJax) {
	      ...
	      }, checkScriptSiblings: function checkScriptSiblings(a) {
	        if (a.MathJax.checked) {
	          ...
	          var d,
	              e,
	              c = a.nextSibling;if (c && c.nodeName !== "#text") {
	            c = null;
	          }if (b.preJax) {
	            ...
	            f.nodeValue = f.nodeValue.replace(b.preJax, d.length > 1 ? d[1] : "");f = null;
	          }if (e && (!b.preJax || d)) {
	      ...
	      }, processInput: function processInput(a) {
	        var b,
	            i = MathJax.ElementJax.STATE;var h,
	            e,
	            d = a.scripts.length;try {
	          while (a.i < d) {
	            h = a.scripts[a.i];if (!h) {
	              a.i++;continue;
	            }e = h.previousSibling;if (e && e.className === "MathJax_Error") {
	              e.parentNode.removeChild(e);
	            }if (!h.MathJax || h.MathJax.state === i.PROCESSED) {
	              a.i++;continue;
	            }if (!h.MathJax.elementJax || h.MathJax.state === i.UPDATE) {
	              this.checkScriptSiblings(h);var g = h.type.replace(/ *;(.|\s)*/, "");var j = this.inputJax[g];b = j.Process(h, a);if (typeof b === "function") {
	                if (b.called) {
	                  continue;
	                }this.RestartAfter(b);
	              }b = b.Attach(h, j.id);this.saveScript(b, a, h, i);this.postInputHooks.Execute(b, j.id, h);
	            } else {
	              if (h.MathJax.state === i.OUTPUT) {
	                this.saveScript(h.MathJax.elementJax, a, h, i);
	              }
	            }a.i++;var c = new Date().getTime();if (c - a.start > this.processUpdateTime && a.i < a.scripts.length) {
	        ...
	        }a.start = new Date().getTime();a.i = a.j = 0;return null;
	      }, postInputHooks: MathJax.Callback.Hooks(true), saveScript: function saveScript(a, d, b, c) {
	        if (!this.outputJax[a.mimeType]) {
	          b.MathJax.state = c.UPDATE;throw Error("No output jax registered for " + a.mimeType);
	        }a.outputJax = this.outputJax[a.mimeType][0].id;if (!d.jax[a.outputJax]) {
	      ...
	      }, prepareOutput: function prepareOutput(c, f) {
	        while (c.j < c.jaxIDs.length) {
	          var e = c.jaxIDs[c.j],
	              d = MathJax.OutputJax[e];if (d[f]) {
	            try {
	              var a = d[f](c);if (typeof a === "function") {
	                if (a.called) {
	                  continue;
	                }this.RestartAfter(a);
	              }
	              ...
	              if (!b.restart) {
	                MathJax.Message.Set(["PrepError", "Error preparing %1 output (%2)", e, f], null, 600);MathJax.Hub.lastPrepError = b;c.j++;
	              }return MathJax.Callback.After(["prepareOutput", this, c, f], b.restart);
	            }
	          }c.j++;
	        }return null;
	      }, processOutput: function processOutput(h) {
	        var b,
	            g = MathJax.ElementJax.STATE,
	            d,
	            a = h.scripts.length;try {
	          while (h.i < a) {
	            d = h.scripts[h.i];if (!d || !d.MathJax || d.MathJax.error) {
	              h.i++;continue;
	            }var c = d.MathJax.elementJax;if (!c) {
	              h.i++;continue;
	            }b = MathJax.OutputJax[c.outputJax].Process(d, h);if (b !== false) {
	              d.MathJax.state = g.PROCESSED;if (d.MathJax.preview) {
	                d.MathJax.preview.innerHTML = "";
	              }this.signal.Post(["New Math", c.inputID]);
	            }h.i++;var e = new Date().getTime();if (e - h.start > this.processUpdateTime && h.i < h.scripts.length) {
	              h.start = e;this.RestartAfter(MathJax.Callback.Delay(this.processUpdateDelay));
	            }
	          }
	        } catch (f) {
	          return this.processError(f, h, "Output");
	        }if (h.scripts.length && this.config.showProcessingMessages) {
	          MathJax.Message.Set(["TypesetMath", "Typesetting math: %1%%", 100], 0);MathJax.Message.Clear(0);
	        }h.i = h.j = 0;return null;
	      }, processMessage: function processMessage(d, b) {
	        var a = Math.floor(d.i / d.scripts.length * 100);var c = b === "Output" ? ["TypesetMath", "Typesetting math: %1%%"] : ["ProcessMath", "Processing math: %1%%"];if (this.config.showProcessingMessages) {
	          MathJax.Message.Set(c.concat(a), 0);
	        }
	      }, processError: function processError(b, c, a) {
	        if (!b.restart) {
	          if (!this.config.errorSettings.message) {
	            throw b;
	          }this.formatError(c.scripts[c.i], b);c.i++;
	        }this.processMessage(c, a);return MathJax.Callback.After(["process" + a, this, c], b.restart);
	      }, formatError: function formatError(b, f) {
	        var h = function h(l, k, j, i) {
	        ...
	        }e += "\n\n" + h("ErrorTips", "Debugging tips: use %1, inspect %2 in the browser console", "'unpacked/MathJax.js'", "'MathJax.Hub.lastError'");b.MathJax.error = MathJax.OutputJax.Error.Jax(e, b);if (b.MathJax.elementJax) {
	          b.MathJax.error.inputID = b.MathJax.elementJax.inputID;
	        }var g = this.config.errorSettings;var a = h(g.messageId, g.message);var c = MathJax.HTML.Element("span", { className: "MathJax_Error", jaxID: "Error", isMathJax: true, id: b.MathJax.error.inputID + "-Frame" }, [["span", null, a]]);MathJax.Ajax.Require("[MathJax]/extensions/MathEvents.js", function () {
	        ...
	        });var d = document.getElementById(c.id);if (d) {
	          d.parentNode.removeChild(d);
	        }b.parentNode.insertBefore(c, b);if (b.MathJax.preview) {
	          b.MathJax.preview.innerHTML = "";
	        }this.lastError = f;this.signal.Post(["Math Processing Error", b, f]);
	      }, RestartAfter: function RestartAfter(a) {
	        throw this.Insert(Error("restart"), { restart: MathJax.Callback(a) });
	      }, elementCallback: function elementCallback(c, f) {
	        if (f == null && (c instanceof Array || typeof c === "function")) {
	          ...
	          c = [c];
	        }c = [].concat(c);for (var b = 0, a = c.length; b < a; b++) {
	      ...
	      }, elementScripts: function elementScripts(e) {
	        var b = [];if (e instanceof Array || this.isHTMLCollection(e)) {
	          for (var d = 0, a = e.length; d < a; d++) {
	            var f = 0;for (var c = 0; c < d && !f; c++) {
	              f = e[c].contains(e[d]);
	            }if (!f) {
	          ...
	          return [e];
	        }b = e.getElementsByTagName("script");if (this.msieHTMLCollectionBug) {
	          b = this.HTMLCollection2Array(b);
	        }return b;
	      }, isHTMLCollection: function isHTMLCollection(a) {
	        return "HTMLCollection" in window && (typeof a === "undefined" ? "undefined" : _typeof(a)) === "object" && a instanceof HTMLCollection;
	      }, HTMLCollection2Array: function HTMLCollection2Array(c) {
	        if (!this.msieHTMLCollectionBug) {
	          return [].slice.call(c);
	        }var b = [];for (var d = 0, a = c.length; d < a; d++) {
	          b[d] = c[d];
	        }return b;
	      }, Insert: function Insert(c, a) {
	        for (var b in a) {
	          if (a.hasOwnProperty(b)) {
	            if (_typeof(a[b]) === "object" && !(a[b] instanceof Array) && (_typeof(c[b]) === "object" || typeof c[b] === "function")) {
	              this.Insert(c[b], a[b]);
	            } else {
	              c[b] = a[b];
	            }
	      ...
	      }, getTabOrder: function getTabOrder(a) {
	        return this.config.menuSettings.inTabOrder ? 0 : -1;
	      }, SplitList: "trim" in String.prototype ? function (a) {
	        return a.trim().split(/\s+/);
	      } : function (a) {
	        return a.replace(/^\s+/, "").replace(/\s+$/, "").split(/\s+/);
	      } };MathJax.Hub.Insert(MathJax.Hub.config.styles, MathJax.Message.styles);MathJax.Hub.Insert(MathJax.Hub.config.styles, { ".MathJax_Error": MathJax.Hub.config.errorSettings.style });MathJax.Extension = {};MathJax.Hub.Configured = MathJax.Callback({});MathJax.Hub.Startup = { script: "", queue: MathJax.Callback.Queue(), signal: MathJax.Callback.Signal("Startup"), params: {}, Config: function Config() {
	        this.queue.Push(["Post", this.signal, "Begin Config"]);if (this.params.locale) {
	          MathJax.Localization.resetLocale(this.params.locale);MathJax.Hub.config.menuSettings.locale = this.params.locale;
	        }if (this.params.config) {
	          var c = this.params.config.split(/,/);for (var b = 0, a = c.length; b < a; b++) {
	            if (!c[b].match(/\.js$/)) {
	              c[b] += ".js";
	            }this.queue.Push(["Require", MathJax.Ajax, this.URL("config", c[b])]);
	          }
	        }this.queue.Push(["Config", MathJax.Hub, MathJax.AuthorConfig]);if (this.script.match(/\S/)) {
	      ...
	      }, ConfigDelay: function ConfigDelay() {
	        var a = this.params.delayStartupUntil || MathJax.Hub.config.delayStartupUntil;if (a === "onload") {
	          return this.onload;
	        }if (a === "configured") {
	          return MathJax.Hub.Configured;
	        }return a;
	      }, ConfigBlocks: function ConfigBlocks() {
	        var c = document.getElementsByTagName("script");var f = null,
	            b = MathJax.Callback.Queue();for (var d = 0, a = c.length; d < a; d++) {
	          var e = String(c[d].type).replace(/ /g, "");if (e.match(/^text\/x-mathjax-config(;.*)?$/) && !e.match(/;executed=true/)) {
	            c[d].type += ";executed=true";f = b.Push(c[d].innerHTML + ";\n1;");
	          }
	        }return f;
	        ...
	        return this.queue.Push(["Post", this.signal, "Begin Cookie"], ["Get", MathJax.HTML.Cookie, "menu", MathJax.Hub.config.menuSettings], [function (e) {
	          var d = e.menuSettings;if (d.locale) {
	            MathJax.Localization.resetLocale(d.locale);
	          }var g = e.menuSettings.renderer,
	              b = e.jax;if (g) {
	            var c = "output/" + g;b.sort();for (var f = 0, a = b.length; f < a; f++) {
	        ...
	        var f = MathJax.Hub.config,
	            c = MathJax.Hub.outputJax;for (var g = 0, b = f.jax.length, d = 0; g < b; g++) {
	          var e = f.jax[g].substr(7);if (f.jax[g].substr(0, 7) === "output/" && c.order[e] == null) {
	            c.order[e] = d;d++;
	          }
	        }var a = MathJax.Callback.Queue();return a.Push(["Post", this.signal, "Begin Jax"], ["loadArray", this, f.jax, "jax", "config.js"], ["Post", this.signal, "End Jax"]);
	      }, Extensions: function Extensions() {
	        var a = MathJax.Callback.Queue();return a.Push(["Post", this.signal, "Begin Extensions"], ["loadArray", this, MathJax.Hub.config.extensions, "extensions"], ["Post", this.signal, "End Extensions"]);
	        ...
	        if (MathJax.Hub.config.positionToHash && document.location.hash && document.body && document.body.scrollIntoView) {
	          var d = document.location.hash.substr(1);var f = document.getElementById(d);if (!f) {
	            var c = document.getElementsByTagName("a");for (var e = 0, b = c.length; e < b; e++) {
	              if (c[e].name === d) {
	                f = c[e];break;
	              }
	            }
	            ...
	            while (!f.scrollIntoView) {
	              f = f.parentNode;
	            }f = this.HashCheck(f);if (f && f.scrollIntoView) {
	              setTimeout(function () {
	      ...
	      }, HashCheck: function HashCheck(b) {
	        var a = MathJax.Hub.getJaxFor(b);if (a && MathJax.OutputJax[a.outputJax].hashCheck) {
	          b = MathJax.OutputJax[a.outputJax].hashCheck(b);
	        }return b;
	      }, MenuZoom: function MenuZoom() {
	        ...
	        var a = this.onload = MathJax.Callback(function () {
	          ...
	          window.addEventListener("load", a, false);if (!this.params.noDOMContentEvent) {
	      ...
	      }, URL: function URL(b, a) {
	        if (!a.match(/^([a-z]+:\/\/|\[|\/)/)) {
	          a = "[MathJax]/" + b + "/" + a;
	        }return a;
	      }, loadArray: function loadArray(b, f, c, a) {
	        if (b) {
	          if (!(b instanceof Array)) {
	            ...
	            var h = MathJax.Callback.Queue(),
	                j = {},
	                e;for (var g = 0, d = b.length; g < d; g++) {
	              e = this.URL(f, b[g]);if (c) {
	                e += "/" + c;
	              }if (a) {
	      ...
	      var b = window[d],
	          e = "[" + d + "]";var c = b.Hub,
	          a = b.Ajax,
	          f = b.Callback;var g = MathJax.Object.Subclass({ JAXFILE: "jax.js", require: null, config: {}, Init: function Init(i, h) {
	          if (arguments.length === 0) {
	            return this;
	          }return this.constructor.Subclass(i, h)();
	        }, Augment: function Augment(k, j) {
	          ...
	          }c.Insert(i.prototype, h);i.Augment(null, j);return this;
	        }, Translate: function Translate(h, i) {
	          throw Error(this.directory + "/" + this.JAXFILE + " failed to define the Translate() method");
	        }, Register: function Register(h) {}, Config: function Config() {
	          this.config = c.CombineConfig(this.id, this.config);if (this.config.Augment) {
	            this.Augment(this.config.Augment);
	          }
	        }, Startup: function Startup() {}, loadComplete: function loadComplete(i) {
	          if (i === "config.js") {
	            return a.loadComplete(this.directory + "/" + i);
	          } else {
	            var h = f.Queue();h.Push(c.Register.StartupHook("End Config", {}), ["Post", c.Startup.signal, this.id + " Jax Config"], ["Config", this], ["Post", c.Startup.signal, this.id + " Jax Require"], [function (j) {
	            ...
	            }, this.config || {}, this.id], ["Post", c.Startup.signal, this.id + " Jax Startup"], ["Startup", this], ["Post", c.Startup.signal, this.id + " Jax Ready"]);if (this.copyTranslate) {
	              h.Push([function (j) {
	        ...
	        } }, { id: "Jax", version: "2.6.0", directory: e + "/jax", extensionDir: e + "/extensions" });b.InputJax = g.Subclass({ elementJax: "mml", sourceMenuTitle: ["Original", "Original Form"], copyTranslate: true, Process: function Process(l, q) {
	          var j = f.Queue(),
	              o;var k = this.elementJax;if (!(k instanceof Array)) {
	            k = [k];
	          }for (var n = 0, h = k.length; n < h; n++) {
	            o = b.ElementJax.directory + "/" + k[n] + "/" + this.JAXFILE;if (!this.require) {
	              this.require = [];
	            } else {
	          ...
	          }o = this.directory + "/" + this.JAXFILE;var p = j.Push(a.Require(o));if (!p.called) {
	            this.constructor.prototype.Process = function () {
	              if (!p.called) {
	                return p;
	              }throw Error(o + " failed to load properly");
	            };
	          }k = c.outputJax["jax/" + k[0]];if (k) {
	            j.Push(a.Require(k[0].directory + "/" + this.JAXFILE));
	          }return j.Push({});
	        }, needsUpdate: function needsUpdate(h) {
	          var i = h.SourceElement();return h.originalText !== b.HTML.getScript(i);
	        }, Register: function Register(h) {
	          if (!c.inputJax) {
	            c.inputJax = {};
	          }c.inputJax[h] = this;
	        } }, { id: "InputJax", version: "2.6.0", directory: g.directory + "/input", extensionDir: g.extensionDir });b.OutputJax = g.Subclass({ copyTranslate: true, preProcess: function preProcess(j) {
	          var i,
	              h = this.directory + "/" + this.JAXFILE;this.constructor.prototype.preProcess = function (k) {
	            if (!i.called) {
	              return i;
	            }throw Error(h + " failed to load properly");
	          };i = a.Require(h);return i;
	        }, Register: function Register(i) {
	          var h = c.outputJax;if (!h[i]) {
	            h[i] = [];
	        ...
	        }, Remove: function Remove(h) {} }, { id: "OutputJax", version: "2.6.0", directory: g.directory + "/output", extensionDir: g.extensionDir, fontDir: e + (b.isPacked ? "" : "/..") + "/fonts", imageDir: e + (b.isPacked ? "" : "/..") + "/images" });b.ElementJax = g.Subclass({ Init: function Init(i, h) {
	          return this.constructor.Subclass(i, h);
	        }, inputJax: null, outputJax: null, inputID: null, originalText: "", mimeType: "", sourceMenuTitle: ["MathMLcode", "MathML Code"], Text: function Text(i, j) {
	          var h = this.SourceElement();b.HTML.setScript(h, i);h.MathJax.state = this.STATE.UPDATE;return c.Update(h, j);
	        }, Reprocess: function Reprocess(i) {
	          var h = this.SourceElement();h.MathJax.state = this.STATE.UPDATE;return c.Reprocess(h, i);
	        }, Update: function Update(h) {
	          return this.Rerender(h);
	        }, Rerender: function Rerender(i) {
	          var h = this.SourceElement();h.MathJax.state = this.STATE.OUTPUT;return c.Process(h, i);
	        }, Remove: function Remove(h) {
	          if (this.hover) {
	            this.hover.clear(this);
	          }b.OutputJax[this.outputJax].Remove(this);if (!h) {
	            c.signal.Post(["Remove Math", this.inputID]);this.Detach();
	          }
	        ...
	        }, Attach: function Attach(i, j) {
	          var h = i.MathJax.elementJax;if (i.MathJax.state === this.STATE.UPDATE) {
	            h.Clone(this);
	          } else {
	            h = i.MathJax.elementJax = this;if (i.id) {
	              this.inputID = i.id;
	            } else {
	              i.id = this.inputID = b.ElementJax.GetID();this.newID = 1;
	            }
	          }h.originalText = b.HTML.getScript(i);h.inputJax = j;if (h.root) {
	            h.root.inputID = h.inputID;
	          }return h;
	        }, Detach: function Detach() {
	          var h = this.SourceElement();if (!h) {
	            return;
	          }try {
	            delete h.MathJax;
	          } catch (i) {
	        ...
	        } }, { id: "ElementJax", version: "2.6.0", directory: g.directory + "/element", extensionDir: g.extensionDir, ID: 0, STATE: { PENDING: 1, PROCESSED: 2, UPDATE: 3, OUTPUT: 4 }, GetID: function GetID() {
	          this.ID++;return "MathJax-Element-" + this.ID;
	        }, Subclass: function Subclass() {
	          var h = g.Subclass.apply(this, arguments);h.loadComplete = this.prototype.loadComplete;return h;
	        } });b.ElementJax.prototype.STATE = b.ElementJax.STATE;b.OutputJax.Error = { id: "Error", version: "2.6.0", config: {}, errors: 0, ContextMenu: function ContextMenu() {
	        ...
	        }, getJaxFromMath: function getJaxFromMath(h) {
	          return (h.nextSibling.MathJax || {}).error;
	        }, Jax: function Jax(j, i) {
	          var h = MathJax.Hub.inputJax[i.type.replace(/ *;(.|\s)*/, "")];this.errors++;return { inputJax: (h || { id: "Error" }).id, outputJax: "Error", inputID: "MathJax-Error-" + this.errors, sourceMenuTitle: ["ErrorMessage", "Error Message"], sourceMenuFormat: "Error", originalText: MathJax.HTML.getScript(i), errorText: j };
	        } };b.InputJax.Error = { id: "Error", version: "2.6.0", config: {}, sourceMenuTitle: ["Original", "Original Form"] };
	    })("MathJax");(function (o) {
	      var h = window[o];if (!h) {
	        h = window[o] = {};
	      }var d = h.Hub;var s = d.Startup;var w = d.config;var g = document.head || document.getElementsByTagName("head")[0];if (!g) {
	        g = document.childNodes[0];
	      }var b = (document.documentElement || document).getElementsByTagName("script");if (b.length === 0 && g.namespaceURI) {
	        b = document.getElementsByTagNameNS(g.namespaceURI, "script");
	      }var f = new RegExp("(^|/)" + o + "\\.js(\\?.*)?$");for (var q = b.length - 1; q >= 0; q--) {
	        if ((b[q].src || "").match(f)) {
	          s.script = b[q].innerHTML;if (RegExp.$2) {
	            var t = RegExp.$2.substr(1).split(/\&/);for (var p = 0, l = t.length; p < l; p++) {
	              var n = t[p].match(/(.*)=(.*)/);if (n) {
	                s.params[unescape(n[1])] = unescape(n[2]);
	              }
	            }
	          }w.root = b[q].src.replace(/(^|\/)[^\/]*(\?.*)?$/, "").replace(/^(https?:\/\/cdn.mathjax.org\/mathjax\/)(latest)/, "$1" + h.version.split(/\./).slice(0, 2).join(".") + "-$2");h.Ajax.config.root = w.root;break;
	        }
	      }var k = navigator.userAgent;var a = { isMac: navigator.platform.substr(0, 3) === "Mac", isPC: navigator.platform.substr(0, 3) === "Win", isMSIE: "ActiveXObject" in window && "clipboardData" in window, isEdge: "MSGestureEvent" in window && "chrome" in window && window.chrome.loadTimes == null, isFirefox: !!k.match(/Gecko\//) && !k.match(/like Gecko/), isSafari: !!k.match(/ (Apple)?WebKit\//) && !k.match(/ like iPhone /) && (!window.chrome || window.chrome.app == null), isChrome: "chrome" in window && window.chrome.loadTimes != null, isOpera: "opera" in window && window.opera.version != null, isKonqueror: "konqueror" in window && navigator.vendor == "KDE", versionAtLeast: function versionAtLeast(y) {
	          var x = this.version.split(".");y = new String(y).split(".");for (var z = 0, j = y.length; z < j; z++) {
	            if (x[z] != y[z]) {
	              return parseInt(x[z] || "0") >= parseInt(y[z]);
	            }
	          }return true;
	        }, Select: function Select(j) {
	          var i = j[d.Browser];if (i) {
	            return i(d.Browser);
	          }return null;
	        } };var e = k.replace(/^Mozilla\/(\d+\.)+\d+ /, "").replace(/[a-z][-a-z0-9._: ]+\/\d+[^ ]*-[^ ]*\.([a-z][a-z])?\d+ /i, "").replace(/Gentoo |Ubuntu\/(\d+\.)*\d+ (\([^)]*\) )?/, "");d.Browser = d.Insert(d.Insert(new String("Unknown"), { version: "0.0" }), a);for (var v in a) {
	        if (a.hasOwnProperty(v)) {
	          if (a[v] && v.substr(0, 2) === "is") {
	            v = v.slice(2);if (v === "Mac" || v === "PC") {
	              continue;
	            }d.Browser = d.Insert(new String(v), a);var r = new RegExp(".*(Version/| Trident/.*; rv:)((?:\\d+\\.)+\\d+)|.*(" + v + ")" + (v == "MSIE" ? " " : "/") + "((?:\\d+\\.)*\\d+)|(?:^|\\(| )([a-z][-a-z0-9._: ]+|(?:Apple)?WebKit)/((?:\\d+\\.)+\\d+)");var u = r.exec(e) || ["", "", "", "unknown", "0.0"];d.Browser.name = u[1] != "" ? v : u[3] || u[5];d.Browser.version = u[2] || u[4] || u[6];break;
	          }
	        }
	      }try {
	        d.Browser.Select({ Safari: function Safari(j) {
	            var i = parseInt(String(j.version).split(".")[0]);if (i > 85) {
	              j.webkit = j.version;
	            }if (i >= 538) {
	              j.version = "8.0";
	            } else {
	            ...
	            }j.webkit = navigator.appVersion.match(/WebKit\/(\d+)\./)[1];j.isMobile = navigator.appVersion.match(/Mobile/i) != null;j.noContextMenu = j.isMobile;
	          }, Firefox: function Firefox(j) {
	            if ((j.version === "0.0" || k.match(/Firefox/) == null) && navigator.product === "Gecko") {
	              var m = k.match(/[\/ ]rv:(\d+\.\d.*?)[\) ]/);if (m) {
	                j.version = m[1];
	              } else {
	                var i = (navigator.buildID || navigator.productSub || "0").substr(0, 8);if (i >= "20111220") {
	                  j.version = "9.0";
	                } else {
	                  if (i >= "20111120") {
	                    j.version = "8.0";
	          ...
	          }, Chrome: function Chrome(i) {
	            i.noContextMenu = i.isMobile = !!navigator.userAgent.match(/ Mobile[ \/]/);
	          }, Opera: function Opera(i) {
	            i.version = opera.version();
	          }, Edge: function Edge(i) {
	            i.isMobile = !!navigator.userAgent.match(/ Phone/);
	          }, MSIE: function MSIE(j) {
	            j.isMobile = !!navigator.userAgent.match(/ Phone/);j.isIE9 = !!(document.documentMode && (window.performance || window.msPerformance));MathJax.HTML.setScriptBug = !j.isIE9 || document.documentMode < 9;MathJax.Hub.msieHTMLCollectionBug = document.documentMode < 9;if (document.documentMode < 10 && !s.params.NoMathPlayer) {
	              try {
	                new ActiveXObject("MathPlayer.Factory.1");j.hasMathPlayer = true;
	              } catch (m) {}try {
	                if (j.hasMathPlayer) {
	                  var i = document.createElement("object");i.id = "mathplayer";i.classid = "clsid:32F66A20-7614-11D4-BD11-00104BD3F987";g.appendChild(i);document.namespaces.add("m", "http://www.w3.org/1998/Math/MathML");j.mpNamespace = true;if (document.readyState && (document.readyState === "loading" || document.readyState === "interactive")) {
	                    document.write('<?import namespace="m" implementation="#MathPlayer">');j.mpImported = true;
	                  }
	                } else {
	      ...
	      }d.Browser.Select(MathJax.Message.browsers);if (h.AuthorConfig && typeof h.AuthorConfig.AuthorInit === "function") {
	        h.AuthorConfig.AuthorInit();
	      }d.queue = h.Callback.Queue();d.queue.Push(["Post", s.signal, "Begin"], ["Config", s], ["Cookie", s], ["Styles", s], ["Message", s], function () {
	        var i = h.Callback.Queue(s.Jax(), s.Extensions());return i.Push({});
